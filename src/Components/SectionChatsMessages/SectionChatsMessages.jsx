        ...
        <section className='SectionChatsMessages'>
            <header className='SectionChatsMessages-header'>
                ...
                <div className='SectionChatsMessages-header-actions'>
                    ...
                    <div className='SectionChatsMessages-header-actions__dropdownbtn'>
                        <button className='SectionChatsMessages-header-actions-button--dots'>
                        ...
                        <div className='SectionChatsMessages-header-actions__dropdown'>
                            <a href="#">Buscar en el chat</a>
                            <a href="#">Videollamada</a>
