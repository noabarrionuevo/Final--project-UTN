    ...
    <div className='contactsearchform_ContactSearchForm'>
      <div className='header_contactsearchform'>
        ...
        <div className='header_buttons'>
          ...
          <div className='header_contactsearchform--button_icons--dropdown'>
            <button className='header_contactsearchform--button_icons--dots'>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-three-dots-vertical" viewBox="0 0 16 16">
                <path d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0m0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0m0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0" />
              </svg>
            </button>
            <div className='header_contactsearchform--button_icons--dots--content'>
              <a href="#" onClick={onAddContact}>Agregar contacto</a>
              <a href="#">Nuevo chat</a>
              <a href="#">Ajustes</a>
              <a href="#">Perfil</a>
